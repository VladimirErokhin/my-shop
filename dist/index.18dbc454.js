...
router.on("/", async ()=>{
    ...
    const ModuleMain = await require("a69127bc709cf0be");
    const mainPage = ModuleMain.getMainPage();
    pageContainer.append(mainPage);
});
router.on("/catalogue", async ()=>{
    pageContainer.innerHTML = "";
    const ModuleCatalogue = await require("41f42c021105a282");
...
},{"./components/header.js":"iODzc","./components/pageContainer.js":"6pXtL","./components/mainTitle.js":"1BNwr","./components/descr.js":"3Y9Sv","a69127bc709cf0be":"iejFx","41f42c021105a282":"5goOm","e24587c59e4f16a":"9L8T0","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","navigo":"fuSlc"}],"iODzc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Создать шапку
...
function getHeader() {
    ...
    link2.addEventListener("click", function(event) {
        event.preventDefault();
        (0, _mainJs.router).navigate("/catalogue");
    });
...
},{}],"5goOm":[function(require,module,exports) {
module.exports = require("8d50c84d043355ef")(require("d251ab598a26f0f9").getBundleURL("10Mjw") + "catalogue.1fa8cd4a.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("fj9Id"));

},{"8d50c84d043355ef":"61B45","d251ab598a26f0f9":"lgJ39"}],"9L8T0":[function(require,module,exports) {
...
},{}]},["iqNlW","1SICI"], "1SICI", "parcelRequire08cb")
